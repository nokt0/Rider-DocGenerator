...
class CommentToTagsParser(inputReader: BufferedReader) {
    ...
    fun createBlocks(): HashMap<String, ArrayList<ParsedBlockData>> {
        var startedDocComment = false
        val commentBlocks = HashMap<String, ArrayList<ParsedBlockData>>()
                        ...
                        if (startedDocComment) {
                            ...
                            if (mapElement == null) {
                                if (recentHeaderName != null) {
                                    val arrlist = ArrayList<ParsedBlockData>()
